...
public class managelec extends javax.swing.JFrame {
    ...
    public managelec() {
        initComponents();
        try {
            ResultSet r=dbconnect.search("SELECT * FROM lecturers");
            while(r.next()){
                String id=r.getString("id");
                String a=r.getString("lec_name");
                String b=r.getString("emp_id");
                String c=r.getString("fac");
                String d=r.getString("dep");
                String e=r.getString("center");
                String f=r.getString("building");
                String g=r.getString("level");
                String h=r.getString("rank");
                Vector v=new Vector();
                v.add(id);
                v.add(a);
                v.add(b);
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Software Engineering", "Information Technology", "Cyber Security", "Information Systems Engineering", "Data Science", "Network Engineering" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "IT", "SE", "DS", "CSNE", "CS", "ISE" }));
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Main Building", "New Building", "Engineering Building", "Business Building" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jButton11, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(jButton9, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(jButton17, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jButton19, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jButton21, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        ...
        if (r < 0) {
            ...
            try {
                dbconnect.iud("DELETE FROM lecturers WHERE `id`='" + a + "'");
                TableModel tm = jTable1.getModel();
                DefaultTableModel dtm = (DefaultTableModel) tm;
                dtm.removeRow(r);
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        dbconnect.iud("UPDATE lecturers SET lec_name = '" + jTextField2.getText() + "' WHERE `id` = '"+ id +"'");
        dbconnect.iud("UPDATE lecturers SET emp_id = '" + jTextField3.getText() + "' WHERE `id` = '"+ id +"'");
        dbconnect.iud("UPDATE lecturers SET fac = '" + String.valueOf(jComboBox1.getSelectedItem()) + "' WHERE `id` = '"+ id +"'");
        dbconnect.iud("UPDATE lecturers SET dep = '" + String.valueOf(jComboBox2.getSelectedItem()) + "' WHERE `id` = '"+ id +"'");
        dbconnect.iud("UPDATE lecturers SET center = '" + String.valueOf(jComboBox3.getSelectedItem()) + "' WHERE `id` = '"+ id +"'");
        dbconnect.iud("UPDATE lecturers SET building = '" + String.valueOf(jComboBox4.getSelectedItem()) + "' WHERE `id` = '"+ id +"'");
        dbconnect.iud("UPDATE lecturers SET level = '" + String.valueOf(jComboBox5.getSelectedItem()) + "' WHERE `id` = '"+ id +"'");
        dbconnect.iud("UPDATE lecturers SET rank = '" + jTextField4.getText() + "' WHERE `id` = '"+ id +"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(managelec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
