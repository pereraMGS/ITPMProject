...
public class managesub extends javax.swing.JFrame {
    ...
    public managesub() {
        initComponents();
        try {
            ResultSet r=dbconnect.search("SELECT * FROM subjects");
            while(r.next()){
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        ...
        if (r < 0) {
            ...
            String a = String.valueOf(o);
            try {
                dbconnect.iud("DELETE FROM subjects WHERE `id`='" + a + "'");
                TableModel tm = jTable1.getModel();
                DefaultTableModel dtm = (DefaultTableModel) tm;
                dtm.removeRow(r);
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        dbconnect.iud("UPDATE subjects SET oy = '" + String.valueOf(jComboBox1.getSelectedItem()) + "' WHERE `id` = '"+ id +"'");
        dbconnect.iud("UPDATE subjects SET sn = '" + jTextField3.getText() + "' WHERE `id` = '"+ id +"'");
        dbconnect.iud("UPDATE subjects SET sc = '" + jTextField4.getText() + "' WHERE `id` = '"+ id +"'");
        dbconnect.iud("UPDATE subjects SET lh = '" + jTextField5.getText() + "' WHERE `id` = '"+ id +"'");
        dbconnect.iud("UPDATE subjects SET th = '" + jTextField6.getText() + "' WHERE `id` = '"+ id +"'");
        dbconnect.iud("UPDATE subjects SET labh = '" + jTextField7.getText() + "' WHERE `id` = '"+ id +"'");
        dbconnect.iud("UPDATE subjects SET eh = '" + jTextField9.getText() + "' WHERE `id` = '"+ id +"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(managesub.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
