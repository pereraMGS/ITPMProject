...
public class manageses extends javax.swing.JFrame {
    ...
    public manageses() {
        initComponents();
        try {
            ResultSet r=dbconnect.search("SELECT * FROM sessions");
            while(r.next()){
    ...
    private void jButton39ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton39ActionPerformed
        ...
        if (r < 0) {
            ...
            try {
                dbconnect.iud("DELETE FROM sessions WHERE `id`='" + a + "'");
                TableModel tm = jTable1.getModel();
                DefaultTableModel dtm = (DefaultTableModel) tm;
                dtm.removeRow(r);
    ...
    private void jButton41ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton41ActionPerformed
        ...
        dbconnect.iud("UPDATE sessions SET stu = '" + jTextField8.getText() + "' WHERE `id` = '"+ id +"'");
        dbconnect.iud("UPDATE sessions SET ss = '" + jTextField9.getText() + "' WHERE `id` = '"+ id +"'");
        dbconnect.iud("UPDATE sessions SET d = '" + jTextField10.getText() + "' WHERE `id` = '"+ id +"'");
        dbconnect.iud("UPDATE sessions SET sg = '" + jTextField11.getText() + "' WHERE `id` = '"+ id +"'");
        dbconnect.iud("UPDATE sessions SET selec_lec = '" + jTextField12.getText() + "' WHERE `id` = '"+ id +"'");
        dbconnect.iud("UPDATE sessions SET st = '" + jTextField13.getText() + "' WHERE `id` = '"+ id +"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(manageses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
